    ...
    <div className="flex justify-center bg-gray-50 min-h-screen py-8 px-2">
      ...
      {ricetta?.author && (
        <div className="w-full flex justify-end pr-8 pb-4">
          <div className="flex items-center gap-2 text-gray-500 text-sm bg-white/80 rounded-full px-4 py-2 shadow border border-gray-200">
            <i className="fa-solid fa-user mr-1" />
            <span>Autore:</span>
            <Link to={`/chef/${ricetta.author_id}`} className="text-refresh-blue hover:underline font-semibold">
              {ricetta.author}
            </Link>
          </div>
        </div>
