                      ...
                      ingredienti.map((ing, idx) => (
                        ...
                        >
                          ...
                          <span className="bg-refresh-pink/10 text-refresh-pink font-bold rounded-full px-3 py-1 text-sm ml-4 shadow-inner">
                             {ing.unita === 'q.b.' ? 'q.b.' : `${(() => {
                                const quantita = (ing.grammi * (numPorzioni || ricetta?.porzioni || 0.1)) / (ricetta?.porzioni || 1);
                                const quantitaArrotondata = quantita < 1 ? quantita.toFixed(1) : Math.ceil(quantita);
                                return quantitaArrotondata;
                              })()
                              }${ing.unita && ing.unita !== 'n' ? ing.unita : ''}`.replace(/^1q\.b\.$/, 'q.b.')}
